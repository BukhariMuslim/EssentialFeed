...
class FeedImageDataLoaderCacheDecoratorTests: XCTestCase, FeedImageDataLoaderTestCase {
    ...
    func test_init_doesNotLoadingImageData() {
    ...
    private func makeSUT(cache: CacheSpy = .init(), file: StaticString = #filePath, line: UInt = #line) -> (sut: FeedImageDataLoader, loader: FeddImageDataLoaderSpy) {
        let loader = FeddImageDataLoaderSpy()
