...
class CommentsUIIntegrationTests: XCTestCase {
    ...
    func test_loadCommentsActions_runsAutomaticallyOnlyOnFirstAppearance() throws {
        let (sut, loader) = try makeSUT()
        XCTAssertEqual(loader.loadCommentsCallCount, 0, "Expected no loading requests before view appears")
    ...
    func test_loadingCommandsIndicator_isVisibleWhileLoadingComments() throws {
        let (sut, loader) = try makeSUT()
    ...
    func test_loadCommentsCompletion_rendersSuccessfullyLoadedComments() throws {
    ...
    func test_loadCommentsCompletion_rendersSuccessfullyLoadedEmptyCommentsAfterNonEmptyComments() throws {
    ...
    func test_loadCommentsCompletion_doesNotAlterCurrentRenderingStateOnError() throws {
        let comment = makeComment()
        let (sut, loader) = try makeSUT()
    ...
    func test_loadCommentsCompletion_dispatchesFromBackgroundToMainThread() throws {
        let (sut, loader) = try makeSUT()
        sut.simulateAppearance()
    ...
    func test_loadCommentsCompletion_rendersErrorMessageOnErrorUntilNextReload() throws {
        let (sut, loader) = try makeSUT()
    ...
    func test_deinit_cancelsRunningRequest() throws {
