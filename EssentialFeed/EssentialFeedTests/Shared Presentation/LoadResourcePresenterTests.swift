...
class LoadResourcePresenterTests: XCTestCase {
    ...
    func test_didFinishLoadingFeedWithError_displaysLocalizedErrorAndstopsLoading() throws {
        let (sut, view) = try makeSUT()
    ...
    private func makeSUT(file: StaticString = #filePath, line: UInt = #line) throws -> (sut: LoadResourcePresenter, view: ViewSpy) {
        let view = ViewSpy()
