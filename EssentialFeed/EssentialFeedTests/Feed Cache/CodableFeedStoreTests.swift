...
//  EssentialFeedTests
//
//  Created by Bukhari Muslim on 15/05/25.
//
...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_retrieve_deliversFoundValueOnEmptyCache() {
        let sut = makeSUT()
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completeOperationInOrder, [op1, op2, op3], "Expected side-effects to run serialy but operations finished in the wrong order")
    }
